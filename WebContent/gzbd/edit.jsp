...
<center><h2>鄞州区社区专职工作人员工资变动审批表</h2></center>
	<table align="center" class="hovertable" border="0" cellpadding="0"
		cellspacing="0">
  <tr >
    <td width="15%" valign="top" class="querytitle">姓名</td>
    <td width="18%" valign="top"><s:textfield name="vo.sgry.xm" id="xm" cssClass="text" size="10" readOnly="true" /><s:if test="%{ (bz=='sq'|| bz=='edit')}"><input type="button" name="dialog" value="选择" onClick="dialog2()"></s:if><!--<a id="btnEp"	href="javascript:dialog('dg')"> 选择</a>--> </td>
    <td width="17%" valign="top" class="title">性别</td>
    <td width="17%" valign="top" ><s:if test='%{vo.sgry.xb==0}'><s:textfield name="xb" id="xb" value='女' cssClass="text" size="10" readOnly="true" /></s:if><s:else><s:textfield name="xb" id="xb" value='男' cssClass="text" size="10" readOnly="true" /></s:else></td>
