...
<html>
	...
	<script type="text/javascript">
				...
				function operate(value,row,index){
				    var zt=row.zt;
				    var html = "";
				    html += "<a href='#' onclick='doAjaxOpen(\"dg\",\"table_open.do\",\""+row.id+"\", \"\",400,230,\"\")'>修改</a> ";
		            html += "<a href='#' onclick='doAjaxDel(\"dg\",\"table_del.do\",\""+row.id+"\", \"\")'>删除</a> ";
	...
	<body>
		...
		<s:set var="columslist"
			value="{
				...
				#{'field':'lm','title':'类名','sortable':'true','width':'100'},
				#{'field':'zjm','title':'主键名','sortable':'true','width':'100'},
				#{'field':'zwmc','title':'表中文名','sortable':'true','width':'100'}
		       
				 
 			}" />
		<s:set var="queryCondits"
			value="{
		        #{'field':'lm', 'type':'string', 'logic':'like', 'value':'lm'}
				}" />

		<tags:gridTag gridId="dg" loadUrl="table_list.do" addUrl="table_open.do"
			winheight="230" winwidth="400" columsPropes="${columslist}"
			queryCondits="${queryCondits}" sortColum="lm" sortOrder="desc"
			width="99%" />
