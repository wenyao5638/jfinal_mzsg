 ...
 $(function(){
	 ...
	 var contextPath = $('#contextPath').val();
			...
			　　　title:'社工调动列表',
				...
				loadMsg : '数据装载中......', 
				fit: true,
				url:'<%=contextPath%>/sgdcsq/sgdcsqList.do?search.zt=<s:property value="zt"/>&cz='+cz,
				frozenColumns:[[
...
<input type="hidden" id="m" name="m"/>
	...
	<<div region="center" class="gridback">
		<div id="dg"  border=0 pagination="true" title="社工工资变动列表" rownumbers="true" singleSelect="true" fit="true">
			</div>
	</div>
</div>
