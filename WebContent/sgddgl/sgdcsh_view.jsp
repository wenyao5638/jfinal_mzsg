...
<form id="sgdcsp" method="post"  name="sgdcsp"
	action="<%=contextPath%>/sgdcsh/drsh.do">
...
<%--			<td colspan="4"><s:textfield name="search.xsq" id="xsq" size="35" readOnly="true" /></td>--%>
		...
		<tr>
			...
			<td colspan="4"><s:textarea name="search.jddrshyj" id="jddrshyj" rows="5" cols="35"/></td>
		</tr>
		<tr>
   ...
   <s:textfield name="search.tjr" id="tjr" size="10" vreadOnly="true"/>
	 ...
	 <s:elseif test="%{cz==1 &&(bz=='sh')}">
		 <a id="button2" class="easyui-linkbutton" icon="icon-ok" href="javascript:drsh('03')" >调入批准</a>&nbsp;&nbsp;
		  <a id="button3" class="easyui-linkbutton" icon="icon-ok" href="javascript:drsh('02')" >调入退回</a>
				</s:elseif>
				  <s:else>
	   <a id="" class="l-btn" href="javascript:void(0)" onClick="closeWin('社工调动申请清单');"> <span
			class="l-btn-left"> <span class="icon-ok"
...
//打开选择界面
 function dialog2(){
 	doAjaxOpen("dg","<%=contextPath%>/sgry/sgry.do","", "&m="+m,800,400,"sgryxz");
 }
