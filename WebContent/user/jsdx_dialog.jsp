...
//角色	
	...
	var contextPath = $('#contextPath').val();
			$('#tt2').datagrid({
				...
				loadMsg : '数据装载中......', 
				fit: true,
				url:'<%=contextPath%>/user/users_jsdxDialog.do?jsdx=<s:property value="#request.jsdx"/>',
				sortName: 'username',
				sortOrder: 'desc',
				idField:'uid',
				frozenColumns:[[
				...
				columns:[[
			        ...
			        {field:'cnname',title:'姓名',width:120},
