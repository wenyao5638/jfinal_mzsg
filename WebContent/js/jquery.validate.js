 ...
 *
 * $Id: jquery.validate.js,v 1.2 2015/03/18 08:37:51 cvsadmin Exp $
 *
...
$.extend($.validator, {
	...
	messages: {
		...
		isPhone:"\u8bf7\u8f93\u5165\u6b63\u786e\u683c\u5f0f\u7684\u7535\u8bdd\u53f7\u7801",
		isIdCardNo:"\u8bf7\u8f93\u5165\u6b63\u786e\u683c\u5f0f\u7684\u8eab\u4efd\u8bc1\u53f7\u7801",
		isMoney:"\u8bf7\u8f93\u5165\u6b63\u786e\u683c\u5f0f\u7684\u91d1\u989d",
		isZipcode:"\u8bf7\u8f93\u5165\u6b63\u786e\u683c\u5f0f\u7684\u90ae\u653f\u7f16\u7801",
		url: "\u8bf7\u8f93\u5165\u5408\u6cd5\u7684\u7f51\u5740",
		date: "\u8bf7\u8f93\u5165\u5408\u6cd5\u7684\u65e5\u671f",
		time: "\u8bf7\u8f93\u5165\u5408\u6cd5\u7684\u65f6\u95f4",
		datetime : "\u8bf7\u8f93\u5165\u5408\u6cd5\u7684\u65e5\u671f\u65f6\u95f4",
	...
	prototype: {
		...
		elements: function() {
			var validator = this,
				...
				var c=this.currentForm.elements;
		...
		getLength: function(value, element) {
			...
			case 'select':
				str = $("option:selected", element).length;
			case 'input':
				if( this.checkable( element) )
					str = this.findByName(element.name).filter(':checked').length;
			}
			var len = str.length;
	...
	methods: {
		...
		isMobile:function(value,element){
			var mobile = /^(\d{3,4}-?)?\d{7,9}$/g;   
			return this.optional(element) || (mobile.test(value)); 
		},
		isPhone:function(value,element){
			var phone =/^((0\d{2,3})-)?(\d{7,8})(-(\d{3,}))?$/; 
			var mobile = /^(\d{3,4}-?)?\d{7,9}$/g;   
			return this.optional(element) || (phone.test(value)) || (mobile.test(value)); 
		},
		isIdCardNo:function(value, element){
			return this.optional(element) || (this.isIdCardNo(value));
		},	
		...
		isZipcode:function(value, element){
			var reg = /^\d+$/;
			return this.optional(element) || ((value.length==6) && reg.test(value));
		},
		...
		date: function(value, element) {
			...
			//重新设置日期校验
 			var r = value.match(/^(\d{4})(-|\/)(\d{1,2})(-|\/)(\d{1,2})$/); 
 			if(r==null)
 				return false; 
